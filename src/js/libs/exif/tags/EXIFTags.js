...
export const EXIF_TAGS_THUMBNAIL_LEVEL = 0;


const exifTagsTIFFLevelTags = {
...
export const EXIF_TAGS_DICTIONARY = {
    [EXIF_TAGS_TIFF_LEVEL]: exifTagsTIFFLevelTags,
    [EXIF_TAGS_THUMBNAIL_LEVEL]: exifTagsTIFFLevelTags,
